...
if (tabbers) {
  tabbers.forEach(function (tabber) {
    tabber.addEventListener('click', function (e) {
      e.preventDefault();
      var on = this.dataset.on;
      var all = this.dataset.all;
      var allElems = document.querySelectorAll('.' + all);
...
/* harmony import */ var lightgallery_css_lightgallery_bundle_css__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! lightgallery/css/lightgallery-bundle.css */ "./node_modules/lightgallery/css/lightgallery-bundle.css");
/* harmony import */ var lightgallery_css_lg_thumbnail_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! lightgallery/css/lg-thumbnail.css */ "./node_modules/lightgallery/css/lg-thumbnail.css");
/* harmony import */ var lightgallery_css_lg_zoom_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lightgallery/css/lg-zoom.css */ "./node_modules/lightgallery/css/lg-zoom.css");



 // Core lightGallery styles
 // Thumbnail plugin styles
 // Zoom plugin styles
(0,lightgallery__WEBPACK_IMPORTED_MODULE_0__["default"])(document.getElementById('projects_masonry__grid'), {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var loadMoreMasonryButton = document.getElementById('load-more-masonry');
  if (loadMoreMasonryButton) {
    loadMoreMasonryButton.addEventListener('click', function () {
      var paged = parseInt(loadMoreMasonryButton.getAttribute('data-current-page')) + 1;
      var term = loadMoreMasonryButton.getAttribute('data-term');
      ...
      xhr.onload = function () {
        if (xhr.status >= 200 && xhr.status < 400) {
          ...
          var jsonStartIndex = response.lastIndexOf('{');
          var front = response.substring(0, jsonStartIndex).trim(); // The HTML part
          var jsonString = response.substring(jsonStartIndex).trim(); // The JSON part
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var filterButtons = document.querySelectorAll('.projects_masonry__filter__wrap .filter-button');
  if (window.location.hash) {
    ...
    filterButtons.forEach(function (button) {
      ...
      var buttonHash = button.getAttribute('href').substring(1);
  ...
  filterButtons.forEach(function (button) {
    button.addEventListener('click', function (e) {
      ...
      e.preventDefault();
      var selectedTechnology = this.getAttribute('href').replace('#', '');
...
function filterProjectsByTechnology(selectedTechnology) {
  ...
  var xhr = new XMLHttpRequest();
  var ajaxUrl = proacto_ajax.ajax_url;
  var url = ajaxUrl + '?action=filter_projects&technology=' + encodeURIComponent(selectedTechnology);

  // Open a GET request
  xhr.open('GET', url, true);

  // Optional: Set up a loading indicator
  var grid = document.getElementById('projects_masonry__grid');
  ...
  xhr.onload = function () {
    if (xhr.status >= 200 && xhr.status < 400) {
      ...
      var event = new CustomEvent('projectsLoaded');
      document.dispatchEvent(event);

      // Update the "Show more" button state if needed
      var loadMoreButton = document.getElementById('load-more-masonry');
      if (loadMoreButton) {
...
var portfolio_swiper = null;
var masonry_swiper = null;
var initSwiperForMobile = function initSwiperForMobile() {
  var screenWidth = window.innerWidth;
  // Destroy the swiper if initialized and screen width is more than 980px
  if (portfolio_swiper && screenWidth >= 980) {
    _portfolio_swiper.destroy(true, true);
    var _portfolio_swiper = null;
  }

  // Initialize the swiper if screen width is less than 980px
  if (screenWidth < 980 && !portfolio_swiper) {
    var _portfolio_swiper2 = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.portfolio_swiper', {
  ...
  if (masonry_swiper && screenWidth >= 980) {
    ...
    var _portfolio_swiper3 = null;
  }

  // Initialize the swiper if screen width is less than 980px
  if (screenWidth < 980 && !masonry_swiper) {
    var _masonry_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.photo_gallery__wrap', {
      slidesPerView: 1,
      // 1 slide per page
      spaceBetween: 8,
      // Adjust spacing if needed
...
var testimonials_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.testimonials_swiper', {
...
var baner_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.baner-slider', {
  ...
  autoplay: {
    delay: 3000,
    // Adjust the delay between transitions (5000ms = 5 seconds)
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  splides.forEach(function (splideElement) {
    new _splidejs_splide__WEBPACK_IMPORTED_MODULE_2__["default"](splideElement, {
      easing: "linear",
      type: 'loop',
      // Enable looping
      padding: 48,
      ...
      perMove: 1,
      // Number of slides to move per scroll
      autoplay: true,
      // Enable autoplay
      interval: 0,
...
/* harmony import */ var _helpers_lightbox__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers/lightbox */ "./js/helpers/lightbox.js");
/* harmony import */ var _helpers_clickers__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/clickers */ "./js/helpers/clickers.js");
/* harmony import */ var _helpers_clickers__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_helpers_clickers__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _helpers_sliders__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./helpers/sliders */ "./js/helpers/sliders.js");
/* harmony import */ var _helpers_load_more__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers/load-more */ "./js/helpers/load-more.js");
/* harmony import */ var _helpers_load_more__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_helpers_load_more__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _helpers_projects_filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./helpers/projects-filter */ "./js/helpers/projects-filter.js");
/* harmony import */ var _helpers_projects_filter__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_helpers_projects_filter__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _blocks_info_numbers__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./blocks/info_numbers */ "./js/blocks/info_numbers.js");
/* harmony import */ var _blocks_info_numbers__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_blocks_info_numbers__WEBPACK_IMPORTED_MODULE_6__);

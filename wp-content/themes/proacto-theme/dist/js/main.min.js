...
// init Swiper:
var icons_swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.icons_slider__swiper', {
  // configure Swiper to use modules
  modules: [swiper__WEBPACK_IMPORTED_MODULE_0__.Autoplay, swiper__WEBPACK_IMPORTED_MODULE_0__.FreeMode],
  slidesPerView: "auto",
  ...
  // },
  grabCursor: true,
  // Changes cursor to drag icon
  // freeMode: true,         // Allows free drag
  loop: true,
  watchOverflow: true,
  breakpoints: {
    0: {
      // Apply centered mode from small screens (mobile)
      centeredSlides: true
    },
    768: {
      // Disable centered mode for larger screens (e.g. tablets and desktops)
